...
private:
   ...
   public:
      ...
      static void main();
      static GLfloat get_border() { return border; }
      static void set_border(GLfloat b) { border = b; }
      static void set_moveby(GLfloat m) { moveby = m; }
      static void set_color(string &c) { color = c; }

...
class shape {
   ...
   public:
      ...
      virtual void draw_num(const vertex&, int num) const = 0;
      virtual void show (ostream&) const;
      virtual void draw_outline(const vertex&,
...
class text: public shape {
   ...
   public:
      ...
      virtual void draw_outline(const vertex&,
                                   const rgbcolor&) const override;
      virtual void draw_num(const vertex&, int num) const override;
...
public:
    explicit triangle(const vertex_list& vtxs);
};

class equilateral: public triangle{
public:
     explicit equilateral(GLfloat width);
};
